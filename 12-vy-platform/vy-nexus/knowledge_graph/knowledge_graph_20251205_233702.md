...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:336"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:231"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:168"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:147"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:84"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:63"]:::lowVDR
