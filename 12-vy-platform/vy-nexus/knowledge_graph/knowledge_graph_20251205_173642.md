...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:240"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:165"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:120"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:105"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:60"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:45"]:::lowVDR
