...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:368"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:253"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:184"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:161"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:92"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:69"]:::lowVDR
