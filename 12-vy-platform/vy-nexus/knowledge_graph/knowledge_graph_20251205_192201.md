...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:272"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:187"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:136"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:119"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:68"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:51"]:::lowVDR
