...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:256"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:176"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:128"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:112"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:64"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:48"]:::lowVDR
