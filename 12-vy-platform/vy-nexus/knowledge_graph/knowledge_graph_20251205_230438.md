...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:288"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:198"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:144"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:126"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:72"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:54"]:::lowVDR
