...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:304"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:209"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:152"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:133"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:76"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:57"]:::lowVDR
