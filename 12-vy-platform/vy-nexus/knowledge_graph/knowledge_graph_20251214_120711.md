...
graph TD
    ...
    constraint["CONSTRAINT<br/>VDR:7.0 F:384"]:::mediumVDR
    feedback["FEEDBACK<br/>VDR:7.0 F:264"]:::lowVDR
    flow["FLOW<br/>VDR:7.0 F:192"]:::mediumVDR
    adaptation["ADAPTATION<br/>VDR:7.1 F:168"]:::mediumVDR
    network["NETWORK<br/>VDR:7.4 F:96"]:::mediumVDR
    complexity["COMPLEXITY<br/>VDR:6.8 F:72"]:::lowVDR
